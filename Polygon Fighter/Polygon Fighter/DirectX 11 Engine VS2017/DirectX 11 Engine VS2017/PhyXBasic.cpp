...
void PhysXBasic::initPhysics()
{
	...
	gVehicle4W->mDriveDynData.setUseAutoGears(false);
...
VehicleDesc PhysXBasic::initVehicleDesc()
{
	...
	const PxF32 wheelWidth = 0.4f;//0.4f
...
void PhysXBasic::startBrakeMode()
{
	if (gMimicKeyInputs)
	{
...
//not use 
void PhysXBasic::incrementDrivingMode(const PxF32 timestep)
{
	...
	if (gVehicleModeTimer > gVehicleModeLifetime)
	{
		...
		case eDRIVE_MODE_ACCEL_FORWARDS:
			this->startAccelerateForwardsMode();
			break;
		case eDRIVE_MODE_ACCEL_REVERSE:
			this->startAccelerateReverseMode();
			break;
...
void PhysXBasic::startAccelerateForwardsMode()
{
	if (gMimicKeyInputs)
	{
...
void PhysXBasic::startAccelerateForwardsSecond()
{
...
void PhysXBasic::startAccelerateReverseMode()
{
	gVehicle4W->mDriveDynData.forceGearChange(PxVehicleGearsData::eREVERSE);
...
void PhysXBasic::startTurnHardLeftMode()
{
	if (gMimicKeyInputs)
	{
		gVehicleInputData.setDigitalAccel(true);
...
void PhysXBasic::startTurnHardRightMode()
{
	if (gMimicKeyInputs)
	{
		gVehicleInputData.setDigitalAccel(true);
...
void PhysXBasic::startHandbrakeTurnLeftMode()
{
	if (gMimicKeyInputs)
	{
		gVehicleInputData.setDigitalSteerLeft(true);
...
void PhysXBasic::startHandbrakeTurnRightMode()
{
	if (gMimicKeyInputs)
	{
		gVehicleInputData.setDigitalSteerRight(true);
...
void PhysXBasic::releaseAllControls()
{
	if (gMimicKeyInputs)
	{
